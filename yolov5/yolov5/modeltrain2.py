...
# 📌 1️⃣ 기존 모델 로드
model_path = "dog_behavior_model_v2.h5"
...
def create_sequence_data(base_folder, img_size=(64, 64)):
    ...
    if len(image_data) == 0:
        raise ValueError("❌ 데이터가 없습니다. 경로를 확인하세요.")
...
# 📌 3️⃣ 새로운 데이터셋 로드
new_dataset_path = "C:/PetTrainer_Pro/yolov5/yolov5/data/dataset_dog/SIT"
...
# 📌 5️⃣ 새 모델 저장
new_model_path = "dog_behavior_model_v3.h5"
